...
CREATE TABLE IF NOT EXISTS `candidato` (
  ...
  `entrevSelecReq` tinyint(4) ,
  `entrevSelecPresen` tinyint(4) ,
  `entrevSelecResult` varchar(40) ,
  `evalMedicaReq` tinyint(4) ,
  `evalMedicaPresen` tinyint(4) ,
  `evalMedicaResult` varchar(40) ,
  `evalPsicolgReq` tinyint(4) ,
  `evalPsicologPresen` tinyint(4) ,
  `evalPsicologResult` varchar(40),
  `evalPsicometReq` tinyint(4)  ,
  `evalPsicometPresene` tinyint(4) ,
  `evalPsicometResult` varchar(40) ,
  `evalTecnicaReq` tinyint(4) ,
  `evalTecnicaPresen` tinyint(4) ,
  `evalTecnicaResult` varchar(41) ,
  `evalConocReq` tinyint(4)  ,
  `evalConocPresen` tinyint(4)  ,
  `evalConocResult` varchar(40)  ,
  `entrevFinalReq` tinyint(4) ,
  `entrevFinalPresen` tinyint(4) ,
  `entrevFinalResul` varchar(40) ,
